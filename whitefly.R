...
results3 = aov(SUM_A_adult~District, data = sum_VN)
#summary(results3) #to make visible
#TukeyHSD(results3) #post-hoc test for significant ANOVA #to make visible
...
#TukeyHSD(results4) #post-hoc test for significant ANOVA #to make visible
